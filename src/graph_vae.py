...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='model_mm.pt', help='file to save model to or load model from (default: %(default)s)')
    ...
    if args.mode == 'train':
        ...
        scheduler = torch.optim.lr_scheduler.ExponentialLR(optimizer, gamma=0.995)#0.995)
        ...
        fig.tight_layout()
        fig.savefig('results_plot.pdf', bbox_inches='tight')
        plt.show()
